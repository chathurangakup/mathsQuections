...
export const quectionsSet = [
  ...
  //   id: 5,
  //   quection:
  //     ' රසදිය වායු පීඩන මානයේ පාඨාන්කය අනුව වායුගෝලීය පීඩනය කොපමනද? රසදිය වල ගනත්වය 13600kgm-3  වායු ගෝලීය පීඩනය 10ms-1',
  //   image:
  //     'https://firebasestorage.googleapis.com/v0/b/apescole-bb52b.appspot.com/o/kupchaturanga%40gmail.com%2FScreenshot_8.png?alt=media&token=53d56671-0858-49c0-b5e8-7a1537523eca',
  //   quectionImage: null,
  //   textOrImageAns: 'text',
  //   answers: ['75 Pa', '75 * 3600 * 10pa', '75/100 * 3600 * 10pa', '13600 pa'],
  //   correctAns: '13600 pa',
  //   time: 2,
  // },
  // {
  //   id: 5,
  //   quection:
  //     'පොල් ගසක ගෙඩියක් නටුවෙන් ගිලිහී බිමාට වැටීම් දක්වා වන ප්‍රවේග කාල ප්‍රස්තාරය තෝරන්න.',
  //   image: '',
  //   quectionImage: null,
